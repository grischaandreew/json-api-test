...
return [
    ...
    */
    'resources' => [
        ...
        'contact-people' => App\ContactPerson::class,
        'copyrights' => App\Copyright::class,
        'file-types' => App\FileType::class,
        'filter-categories' => App\FilterCategory::class,
        'fuel-labels' => App\FuelLabel::class,
        'languages' => App\Language::class,
        'magazines' => App\Magazine::class,
        'sections' => App\Section::class,
        'social-posts' => App\SocialPost::class,
        'teasers' => App\Teaser::class,
